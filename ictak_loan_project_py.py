# -*- coding: utf-8 -*-
"""ICTAk_Loan_Project.py

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1088e4q5FceBGDVcY2v1bfEPNHIfGsuKJ
...
print(train_data.isnull().sum().sum())  # print 0

print(test_data.isnull().sum().sum())   # print 0
...
#Training several models and evaluate their accuracy:
